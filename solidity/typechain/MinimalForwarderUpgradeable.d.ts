...
interface MinimalForwarderUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class MinimalForwarderUpgradeable extends BaseContract {
  ...
  interface: MinimalForwarderUpgradeableInterface;
